...
public class Player {
            ...
            if (c.getName().equals(cityName)) {
                ...
                if (type.toLowerCase().equals("farm") || type.toLowerCase().equals("market")) {
                    for (EconomicBuilding e : c.getEconomicalBuildings()) {
                        if ((e instanceof Farm && type.toLowerCase().equals("farm"))
                                || (e instanceof Market && type.toLowerCase().equals("market")))
                            return;
                    }
                } else {
    ...
    public void laySiege(Army army, City city)
            throws TargetNotReachedException, FriendlyCityException {
    ...
    public ArrayList<Army> getControlledArmies() { return controlledArmies; }
}
